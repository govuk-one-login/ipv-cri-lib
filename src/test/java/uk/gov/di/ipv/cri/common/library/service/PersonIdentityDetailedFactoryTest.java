...
class PersonIdentityDetailedFactoryTest {

    @Test
    void shouldCreatePersonIdentityDetailedWithAddresses() {
    ...
    @Test
    void shouldCreatePersonIdentityDetailedWithDrivingPermit() {
        ...
        PersonIdentityDetailed personIdentityDetailed =
                PersonIdentityDetailedFactory.createPersonIdentityDetailedWithDrivingPermit(
    ...
    @Test
    void shouldCreatePersonIdentityDetailedWithPassport() {
        NamePart firstNamePart = new NamePart();
        firstNamePart.setType("GivenName");
        firstNamePart.setValue("Jon");
        NamePart surnamePart = new NamePart();
        ...
        PersonIdentityDetailed personIdentityDetailed =
                PersonIdentityDetailedFactory.createPersonIdentityDetailedWithPassport(
